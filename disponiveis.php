...
<head>
    ...
    <title>Mostrar salas disponíveis</title>
  ...
  <body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <a class="p-2 text-dark" href="ocupadas.php">Mostrar Ocupadas</a>
        <a class="p-2 text-dark" href="mostrar_tudo.php">Mostrar Todas</a>
      </nav>
      <a class="btn btn-outline-primary" href="https://www.google.com.br/#">Google</a>
    </div>
    <div class="flex-column  align-items-center col-auto">
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      	<h1 class="display-4">Salas Disponiveis</h1>
        <p class="lead">Estas são as salas que estão disponiveis para escolha.</p>
      </div>
      <!-- 
        Cada item da lista 
